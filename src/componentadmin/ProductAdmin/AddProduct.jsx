  ...
  return (
    <>
      <div className="addproduct text-start mt-5">
        ...
        <div className="form-addproduct">
          <div className="addproduct-input row">
            <label htmlFor="addproduct">Cara Pemakaian Produk :</label>
            <input type="text" placeholder="Your Answer" />
          </div>
        </div>
        <div className="form-addproduct">
          <div className="addproduct-input row">
            <label htmlFor="addproduct">Kategori Produk :</label>
            <div className="checkbox-container">
              <div className="checkbox-group">
                <input type="radio" id="option1" name="usage" value="option1" />
